...
// To add new job
routerr.post("/jobs", jwtAuth, (req, res) => {
  const user = req.user;
...
routerr.get("/jobs", jwtAuth, (req, res) => {
  let user = req.user;
...
routerr.get("/jobs/:id", jwtAuth, (req, res) => {
...
routerr.put("/jobs/:id", jwtAuth, (req, res) => {
  const user = req.user;
  if (user.type != "recruiter") {
    res.status(401).json({
...
// to delete a job
routerr.delete("/jobs/:id", jwtAuth, (req, res) => {
  const user = req.user;
  if (user.type != "recruiter") {
    res.status(401).json({
...
routerr.get("/user", jwtAuth, (req, res) => {
  const user = req.user;
  if (user.type === "recruiter") {
...
routerr.get("/user/:id", jwtAuth, (req, res) => {
...
// update user details
routerr.put("/user", jwtAuth, (req, res) => {
  const user = req.user;
  const data = req.body;
  if (user.type == "recruiter") {
    Recruiter.findOne({ userId: user._id })
...
routerr.post("/jobs/:id/applications", jwtAuth, (req, res) => {
  const user = req.user;
...
routerr.get("/jobs/:id/applications", jwtAuth, (req, res) => {
  const user = req.user;
  if (user.type != "recruiter") {
    res.status(401).json({
...
routerr.get("/applications", jwtAuth, (req, res) => {
  const user = req.user;
...
routerr.put("/applications/:id", jwtAuth, (req, res) => {
  const user = req.user;
...
routerr.put('/feedback', jwtAuth, async (req, res) => {
  try {
      ...
      if (req.body.filteringProcessFeedback) {
          feedback.feedbackDetails.filteringProcessFeedback = req.body.filteringProcessFeedback;
      }
      if (req.body.improvementSuggestions) {
          feedback.feedbackDetails.improvementSuggestions = req.body.improvementSuggestions;
      }
      if (req.body.jobPostingNotifications) {
        feedback.feedbackDetails.jobPostingNotifications = req.body.jobPostingNotifications;
      }
      if (req.body.personalRecommendations) {
          feedback.feedbackDetails.personalRecommendations = req.body.personalRecommendations;
      }
      if (req.body.userInterfaceExperience) {
          feedback.feedbackDetails.userInterfaceExperience = req.body.userInterfaceExperience;
      }
...
routerr.get("/applicants", jwtAuth, (req, res) => {
  const user = req.user;
  if (user.type === "recruiter") {
    let findParams = {
      recruiterId: user._id,
...
routerr.put("/rating", jwtAuth, (req, res) => {
  const user = req.user;
  const data = req.body;
  if (user.type === "recruiter") {
    // can rate applicant
...
// get personal rating
routerr.get("/rating", jwtAuth, (req, res) => {
  const user = req.user;
  Rating.findOne({
    senderId: user._id,
